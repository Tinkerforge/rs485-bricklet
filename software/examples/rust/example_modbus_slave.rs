...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    //Create receiver for Modbus slave write single register request events.
    let modbus_slave_write_single_register_request_receiver = rs485.get_modbus_slave_write_single_register_request_receiver();
